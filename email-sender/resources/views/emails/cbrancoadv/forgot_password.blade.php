...
@section('button')
	<a class="mcnButton " title="Site" href="{{ $linkButton }}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Clique aqui para Redefinir Senha</a>
@stop
